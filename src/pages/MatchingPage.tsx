    ...
    <div className="bg-white rounded-xl shadow-sm border p-4 sm:p-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center justify-between p-3 sm:p-4 bg-blue-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-base sm:text-lg font-semibold text-gray-900">{mentorCount}</div>
                  <div className="text-xs sm:text-sm text-gray-600">Mentors Ready</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 sm:p-4 bg-green-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-base sm:text-lg font-semibold text-gray-900">{menteeCount}</div>
                  <div className="text-xs sm:text-sm text-gray-600">Mentees Waiting</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 sm:p-4 bg-amber-50 rounded-lg border border-amber-200">
              <div className="flex items-start">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600 mt-0.5 mr-2 sm:mr-3 shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
        <button
          ...
          disabled={isLoading}
          className={`w-full py-3 sm:py-4 px-4 sm:px-6 rounded-lg font-semibold text-base sm:text-lg transition-all duration-200 touch-manipulation ${
            isLoading
...
const ResultsStep = ({ 
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-0">
      <div className="text-center mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-4">🎉 Matching Complete!</h1>
        <p className="text-base sm:text-lg text-gray-600 px-2 sm:px-0">
      ...
      <div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-6 sm:mb-8">
        <div className="bg-white rounded-xl shadow-sm border p-4 sm:p-6 text-center">
          ...
          <div className="text-2xl sm:text-3xl font-bold text-green-600 mb-1 sm:mb-2">{pairs.length}</div>
          <div className="text-xs sm:text-sm font-medium text-gray-600">Successful Matches</div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border p-4 sm:p-6 text-center">
          ...
          <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-1 sm:mb-2">{avgScore}%</div>
          <div className="text-xs sm:text-sm font-medium text-gray-600">Average Score</div>
        </div>

        <div className="bg-white rounded-xl shadow-sm border p-4 sm:p-6 text-center sm:col-span-2 lg:col-span-1">
          ...
          <div className="text-2xl sm:text-3xl font-bold text-orange-600 mb-1 sm:mb-2">{unpairedCount}</div>
          <div className="text-xs sm:text-sm font-medium text-gray-600">Unmatched Mentees</div>
        </div>
      </div>

      <div className="bg-white rounded-xl shadow-sm border p-4 sm:p-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-4 sm:mb-6">What's Next?</h3>
        
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
          <button
            onClick={onViewDetails}
            className="group p-4 sm:p-6 text-left border-2 border-blue-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 touch-manipulation"
            style={{ touchAction: 'manipulation' }}
          >
            <div className="flex items-start space-x-3 sm:space-x-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 shrink-0">
              ...
              <div>
                <h4 className="font-semibold text-sm sm:text-base text-gray-900 group-hover:text-blue-600">Review & Edit Pairs</h4>
          ...
          {onNavigateToAnalysis && (
            <button
              ...
              className="group p-4 sm:p-6 text-left border-2 border-purple-200 rounded-xl hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 touch-manipulation"
              style={{ touchAction: 'manipulation' }}
            >
              <div className="flex items-start space-x-3 sm:space-x-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200 shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </div>
                <div>
                  <h4 className="font-semibold text-sm sm:text-base text-gray-900 group-hover:text-purple-600">Advanced Analytics</h4>
                  <p className="text-xs sm:text-sm text-gray-600 mt-1">
        ...
        <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200">
          <button
            onClick={onRunAgain}
            className="text-sm text-gray-500 hover:text-gray-700 transition-colors touch-manipulation"
            style={{ touchAction: 'manipulation' }}
          >
...
const ReviewStep = ({ 
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-0">
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8 gap-4">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">Review Matches</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:space-x-4">
        <button
          ...
          className="px-4 py-2 text-gray-600 hover:text-gray-800 transition-colors touch-manipulation order-2 sm:order-1"
          style={{ touchAction: 'manipulation' }}
        >
          ← Back to Summary
        </button>
        <button
          onClick={onExport}
          className="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors touch-manipulation order-1 sm:order-2"
          style={{ touchAction: 'manipulation' }}
        >
          Export Results
        </button>
    ...
    <div className="bg-white rounded-t-xl sm:rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
      <div className="p-4 sm:p-6 border-b border-gray-200 sticky top-0 bg-white">
        <div className="flex items-center justify-between">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Export Matching Results</h2>
          <button
            onClick={onClose}
      ...
      <div className="p-4 sm:p-6">
        <div className="space-y-3 sm:space-y-4">
          <button
            ...
            className="w-full p-4 text-left border border-gray-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition-all duration-200 group touch-manipulation"
            style={{ touchAction: 'manipulation' }}
          >
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 rounded-lg flex items-center justify-center group-hover:bg-green-200 shrink-0">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Export as CSV</h3>
                <p className="text-xs sm:text-sm text-gray-600">Perfect for Excel, Google Sheets, and data analysis</p>
              </div>
            </div>
          </button>
          ...
          <button
            ...
            className="w-full p-4 text-left border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 group touch-manipulation"
            style={{ touchAction: 'manipulation' }}
          >
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-lg flex items-center justify-center group-hover:bg-blue-200 shrink-0">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Export as JSON</h3>
                <p className="text-xs sm:text-sm text-gray-600">Complete data structure for developers and integrations</p>
              </div>
            </div>
          </button>
          ...
          <button
            ...
            className="w-full p-4 text-left border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 group touch-manipulation"
            style={{ touchAction: 'manipulation' }}
          >
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 rounded-lg flex items-center justify-center group-hover:bg-purple-200 shrink-0">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Summary Report</h3>
                <p className="text-xs sm:text-sm text-gray-600">Human-readable summary for presentations and reviews</p>
              </div>
            </div>
          </button>
        </div>
    ...
    return (
      <div className="text-center py-8 sm:py-12 px-4">
        <div className="max-w-md mx-auto">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Ready to Start Matching</h1>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-6 sm:mb-8">
        <nav aria-label="Progress">
          <ol className="flex items-center justify-center space-x-4 sm:space-x-8 overflow-x-auto pb-2">
            {[
              ...
              return (
                <li key={step.key} className="flex items-center shrink-0">
                  ...
                  <span className={`ml-2 sm:ml-3 text-xs sm:text-sm font-medium ${isActive ? 'text-blue-600' : 'text-gray-500'}`}>
