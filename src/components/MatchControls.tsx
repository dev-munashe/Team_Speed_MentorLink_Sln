...
export function MatchControls({ 
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border">
      <h3 className="text-lg font-medium text-gray-900 mb-4">Matching Controls</h3>
      ...
      <div className="space-y-4">
        ...
        <div className="flex space-x-3">
          ...
          <button
            onClick={onReset}
            disabled={isLoading}
            className="px-4 py-2 rounded-md font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 transition-colors disabled:opacity-50"
          >
            Reset
          </button>
        </div>
