  ...
  const mockMentees = [
    {
      ...
      goals: ['Land FAANG internship', 'Master system design', 'Build impressive portfolio'],
    ...
    },
    {
      ...
      program_track: 'Full-Stack Bootcamp',
      goals: ['Career transition from finance', 'Build production apps', 'Network in tech'],
